 ...
 * @param   {String}    path
 */
var Request = module.exports.Request = function(response, args, host, method, path) {
 ...
 * @param   {String}    action
 */
var QueryRequest = module.exports.QueryRequest = function(response, args, host, path, version, action) {
 ...
 * @param   {String}    path
 */
var RestRequest = module.exports.RestRequest = function(response, args, host, method, path) {
