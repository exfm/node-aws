...
var Client = function(options) {
  if (null == options || !options instanceof Object) {
    throw new Error('options is a required object');
  }

  if (!isString(options.accessKeyId)) {
    throw new Error('options.accessKeyId is a required string');
  }

  if (!isString(options.secretAccessKey)) {
    throw new Error('options.secretAccessKey is a required string');
  }
...
Client.prototype.request = function(request, callback) {
  ...
  if (null != callback && !callback instanceof Function) {
    throw new Error('callback is a required Function object');
  }
...
var isString = function(string) {
  return (null != string && string instanceof String) || typeof string == 'string';
}
...
var isNumber = function(number) {
  return (null != number && number instanceof Number) || typeof number == 'number' || !isNaN(parseFloat(number));
}
