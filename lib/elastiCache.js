...
// Version Information
var version = module.exports.version  = '2011-07-15';
var xmlns   = module.exports.xmlns    = 'http://elasticache.amazonaws.com/doc/' + version + '/';
var methods = module.exports.methods  = {
  'describeCacheClusters': true,
}
...
var Request = module.exports.Request = function(args, action) {
  ...
  aws.QueryRequest.call(this, args, 'elasticache.' + args.region + '.amazonaws.com', '/', version, action);
...
/**
 * A generic ElastiCache response.
 *
