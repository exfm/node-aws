 ...
 * @param   {String}    action
 */
var Request = module.exports.Response = function(response, args, method) {
  aws.RestRequest.call(this, response, args, 's3.amazonaws.com', method, '/');
}
...
Request.prototype.sign = function(accessKeyId, signature) {
  ...
  this._headers['Authorization']  = 'AWS ' + accessKeyId + ':' + signature;
