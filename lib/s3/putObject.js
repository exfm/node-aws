...
var Request = function(args) {
  ...
  if (null != args.data) {
    self._data                      = _.asString(args.data);
    self._headers['Content-Length'] = self._data.length;
    self._headers['Content-MD5']    = crypto.createHash('md5').update(self._data).digest('base64');
  } else {
