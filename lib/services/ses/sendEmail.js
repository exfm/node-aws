...
module.exports.encodeRequest = function(request, args) {
  ...
  if (args.destination instanceof Object) {
    if (util.isArray(args.destination.bccAddresses)) {
  ...
  if (util.isArray(args.replyToAddresses)) {
